...
CREATE TABLE ventas (
    ...
    INDEX (id_cliente),
    INDEX (id_usuario),
    INDEX (id_configuracion_comprobante),
    FOREIGN KEY (id_cliente) REFERENCES clientes(id_cliente),
    FOREIGN KEY (id_usuario) REFERENCES usuarios(id_usuario),
    FOREIGN KEY (id_configuracion_comprobante) REFERENCES configuracion_comprobante(id)
) ENGINE=InnoDB;

-- ===============================
-- 10.1 CONFIGURACION COMPROBANTE
-- ===============================
CREATE TABLE configuracion_comprobante (
